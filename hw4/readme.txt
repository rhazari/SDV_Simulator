...
5. file.txt : The output file generated after running the simulator. Containing the following three parameters:
              timestamp #active channel-slices  #total subscribers viewing 
...
3. The program takes the following 5 parameters as inputs:
	...
	d. Simulation time duration (Simulation Time)[Keep the simulation time as 100,000 for the results to converge]
	e. Zipf parameter 

Important Note: 
While generating the output to the textfile "file.txt", limit the simulation time to 10,000  
